...
export type ChatModalType =
  ...
  | 'credit-shortage' // 크레딧 부족
  | 'new-session' // 새 상담 안내
  | 'unfinished-session' // 미완결 상담
  | 'end-confirm' // 상담 종료 확인
  | 'record-loading' // 마음기록 제작 대기
  | null;
...
const MOCK_PERSONAS: PersonaCardData[] = [
  {
    ...
    imageUrl: '/images/persona-mental.png',
  },
  {
    id: 'career',
    name: '진로 및 학업 상담사',
    description: '목표 설정, 번아웃 관리, 진로 탐색 등 성취와 관련된 고민 구조화',
    imageUrl: '/images/persona-career.png',
  },
  {
    id: 'coaching',
    name: '코칭 심리 상담사',
    ...
    imageUrl: '/images/persona-coaching.png',
  },
  {
    id: 'locked-1',
    name: '새로운 페르소나',
...
export default function ChatPage() {
  ...
  return (
    ...
    <div className="flex h-[calc(100vh-80px)] gap-10.75 overflow-hidden px-60 pb-29">
      ...
      {/* 상담 종료 확인 모달 (기존 ChatAlertModal 'end' variant 대체) */}
      <StatusModal
