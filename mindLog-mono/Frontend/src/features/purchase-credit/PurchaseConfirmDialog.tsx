...
import { createPaymentApi } from '@/entities/credits/api';
...
interface PurchaseConfirmDialogProps {
  ...
  readonly product: CreditProduct | null;
  /** 초기 단계 지정 (결제 결과 리다이렉트 시 사용) */
  readonly initialStep?: PurchaseStep;
  /** 결제 처리 콜백 — 실제 API 연동 시 사용 */
  readonly onConfirmPurchase?: (product: CreditProduct) => Promise<boolean>;
