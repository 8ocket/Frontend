...
type ChatFilterPanelProps = {
  ...
  readonly startDate?: DateSelector;
  readonly endDate?: DateSelector;
};
...
function DateBlock({
  ...
  readonly date: DateSelector;
  readonly onYearChange: (v: string) => void;
  readonly onMonthChange: (v: string) => void;
  readonly onDayChange: (v: string) => void;
}) {
  return (
