...
export function DeleteReportModal({ isOpen, onClose, onConfirm, isDeleting }: DeleteReportModalProps) {
      ...
      <DialogContent showClose={false} maxWidth="max-w-[350px]" className="p-6">
        <div className="flex flex-col items-center gap-6">
          ...
          <div className="flex flex-col items-center gap-2">
            ...
            />
            <DialogTitle className="w-full text-center text-2xl font-semibold leading-[1.3] tracking-[-0.36px] text-prime-900">
              리포트를 삭제하시나요?
            </DialogTitle>
          </div>

          {/* 본문 */}
          <DialogDescription className="text-prime-700 w-full text-center text-base font-normal leading-[1.6]" style={{ wordBreak: 'keep-all' }}>
            리포트를 삭제할 경우 복구가 불가능합니다.<br />그래도 삭제하시겠습니까?
          </DialogDescription>
          ...
          <label className="flex cursor-pointer items-center gap-1.5">
            ...
            <span className="text-sm font-medium text-black">위 내용을 확인 했습니다.</span>
          </label>
