        ...
        <div className="flex w-full flex-col items-center gap-6">
          ...
          <div className="flex w-full flex-col items-center gap-6">
            ...
            <div className="flex w-full flex-col items-center gap-6">
              ...
              <DialogDescription className="body-1 text-prime-700 w-full text-center whitespace-pre-line">
                {'이전에 중단되어 마무리가 되지 않은 \n상담이 있습니다. 돌아가서 진행하시겠습니까?'}
              </DialogDescription>
            </div>

            {/* Frame 1597881573 — VERTICAL, gap 4, cross CENTER, 302×HUG */}
            <div className="flex w-full flex-col items-center gap-1">
              {/* 세션 제목 — Pretendard Medium 12px, lh 14.4px, ls -0.18px, #945F06, CENTER */}
              {/* VariableID:576:5117 = warning-700 */}
              <span className="text-warning-700 w-full text-center text-xs leading-[120%] font-medium tracking-[-0.18px] break-keep">
                [{sessionTitle}]
              </span>
              {/* 날짜 — Pretendard Medium 12px, lh 14.4px, ls -0.18px, #6983AA, CENTER */}
              {/* VariableID:575:5017 = prime-500 */}
              <span className="text-prime-500 w-full text-center text-xs leading-[120%] font-medium tracking-[-0.18px]">
                {sessionDate}
              </span>
            </div>
          </div>
